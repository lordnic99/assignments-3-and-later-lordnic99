...
void test_validate_my_username()
{
     ...
     *
     */
    const char *my_true_username = my_username();
    const char *my_username_file = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING(my_true_username,my_username_file);
}
